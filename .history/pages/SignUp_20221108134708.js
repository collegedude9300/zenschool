...
const handleSubmit = (e) => {
  ...
  if (validateEmail(email) && validateFirstName(firstName) && validateLastName(lastName) && validatePhoneNumber(phoneNumber) && validateAddress(address) && validateCity(city) && validateState(state) && validateZipCode(zipCode)  && validateDateOfBirth(dateOfBirth) && validatePassword(password) && password === confirmPassword) {
